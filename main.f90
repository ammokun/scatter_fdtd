...
!
            ...
            do j=1,jmax-1
              ...
              hy_s(j,imax)=hy_sb(j,imax-1)+(cc*dt_e-dx)/(cc*dt_e+dx)*(hy_s(j,imax-1)-hy_sb(j,imax)) !mur absorption for incidnet field           
...
!            end do
            ...
            do i=1,imax-1
              ...
              hx_ib(0,i)=hx_i(0,i)
              hx_ib(1,i)=hx_i(1,i) !0,0から出てくる奴を消す
              ...
              hx_ib(jmax-1,i)=hx_i(jmax-1,i) !jmax,0から出てくる奴を消す
